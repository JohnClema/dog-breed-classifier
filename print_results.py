...
def print_results(
    ...
    if print_incorrect_dogs and (
        ...
        for key in results_dic:
            # Print the pet label and classifier label when the classifier function misclassifies dogs
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0) or (
                results_dic[key][3] == 0 and results_dic[key][4] == 1
            ):
                print(
                    f"Pet Label: {results_dic[key][0]}, Classifier Label: {results_dic[key][1]}"
                )
