...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # real answer & classifier's answer. If a dog name already exists in
    # dognames_dic print a Warning statement because you shouldn't find
    # any duplicate dog names in dognames.txt

    dognames_dic = dict()

    # Check for duplicate dog names in dognames_dic
    for dog_name in dognames_dic:
        if dognames_dic[dog_name] > 1:
            print("Warning: Duplicate dog name found in dognames_dic:", dog_name)
